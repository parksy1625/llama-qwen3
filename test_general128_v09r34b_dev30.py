...
# This seed is now a development set after the prior blind R3.3 run.
...
g=General128V09R34B('http://127.0.0.1:9')
correct=routed=0
...
assert correct >= 24, (correct,routed)
assert routed >= 24, (correct,routed)
